...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-flg2uue.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-flg2uue.containers.anotherwebservice.com/
...
```
git clone git@github.com:Solo120140/container-flg2uue.git
cd container-flg2uue
```
...
```
docker attach container-flg2uue
```
